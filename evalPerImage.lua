...
cmd:option('-endAt', 1000, 'end image id')
...
local m = torch.load(config.model..'/temp300.t7')
local c = m.config
...
function fuckyou( img, masks, maxn, alpha, clrs )
